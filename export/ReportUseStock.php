...
?>
<?php
if (isset($_POST["buttonpro"])) {
	header("Content-Type: application/vnd.ms-excel");
	header("Content-Disposition: attachment; filename=ການນຳໃຊ້ ອຸປະກອນ.xls");
?>
	<html lang="en">
	...
	<head>
		...
		if ($_SESSION["iduser"] == "404" or $_SESSION["iduser"] == "30" or $_SESSION["iduser"] == "194" or $_SESSION["iduser"] == "793" or $_SESSION["iduser"] == '51' or $_SESSION["iduser"] == '43' or $_SESSION["iduser"] == '41' or $_SESSION["iduser"] == '378' or $_SESSION["iduser"] == '387' or $_SESSION["iduser"] == '514' or $_SESSION["iduser"] == '423' or $_SESSION["iduser"] == '166' or $_SESSION["iduser"] == '167' or $_SESSION["iduser"] == '168' or $_SESSION["iduser"] == '624' or $_SESSION["iduser"] == '190' or $_SESSION["iduser"] == '197' or $_SESSION["iduser"] == '718' or $_SESSION["iduser"] == '816' or $_SESSION["iduser"] == '835' or $_SESSION["iduser"] == '836' or $_SESSION["iduser"] == '837' or $_SESSION["iduser"] == '177' or $_SESSION["iduser"] == '180' or $_SESSION["iduser"] == '181' or $_SESSION["iduser"] == '487' or $_SESSION["iduser"] == '686') {
			if ($Pro == '' and $Equment == '') {
				$sql = "SELECT * FROM usestock ORDER BY a.Date ASC";
			  } elseif ($Pro == '' and $Equment <> '') {
				$sql = "SELECT * FROM usestock WHERE a.Items LIKE '%$Equment%' ORDER BY a.Date ASC";
			  } elseif ($Pro <> '' and $Equment <> '') {
				$sql = "SELECT*FROM usestock a
				WHERE a.Date >= '$start' and a.Date <= '$end' and a.Provinces like '$Pro' and a.Items like '$Equment'
				ORDER BY a.Date asc ";
			} elseif ($Pro == '' and $Equment <> '') {
				$sql = "SELECT*FROM usestock a
				WHERE a.Date >= '$start' and a.Date <= '$end'  and a.Items like '$Equment'
				ORDER BY a.Date asc ";
			}
		} else {
			if ($Equment == '') {
				$sql = "SELECT*FROM usestock a
				WHERE a.Date >= '$start' and a.Date <= '$end' and a.Provinces like '$namePro'
				ORDER BY a.Date asc ";
			} elseif ($Equment <> '') {
				$sql = "SELECT*FROM usestock a
				WHERE a.Date >= '$start' and a.Date <= '$end' and a.Provinces like '$namePro' and a.Items like '$Equment'
				ORDER BY a.Date asc ";
			}
		}
			...
			<div align="center" class="circle">
				<table class="table table-hover table-bordered table-sm" border="1">
					...
					<tbody>
						...
						?>
							<tr>
								<td width="10%"><?php echo $row['Provinces'] ?></td>
								<td width="10%"><?php echo $row['Items'] ?></td>
								<td width="10%"><?php echo $row['Section'] ?></td>
								<td width="10%"><?php echo $row['Series_Number'] ?></td>
								<td width="10%"><?php echo $row['OA'] ?></td>
								<td width="10%"><?php echo $row['Ticket'] ?></td>
								<td width="10%"><?php echo $row['Use_Name'] ?></td>
								<td width="10%"><?php echo $row['Date'] ?></td>
								<td align="center" width="10%"><?php echo $row['Unit'] ?> </td>
								<td align="center" width="10%"> <?php echo $row['Type'] ?></td>

								<td width="10%"><?php echo $row['Station'] ?></td>

								<td width="10%"><?php echo $row['Remark'] ?></td>

								<td align="center" width="10%"><?php echo $row['User'] ?></td>
			...
			<head>
				...
				if ($_SESSION["iduser"] == "404" or $_SESSION["iduser"] == "30" or $_SESSION["iduser"] == "194" or $_SESSION["iduser"] == "793" or $_SESSION["iduser"] == '51' or $_SESSION["iduser"] == '43' or $_SESSION["iduser"] == '41' or $_SESSION["iduser"] == '378' or $_SESSION["iduser"] == '387' or $_SESSION["iduser"] == '514' or $_SESSION["iduser"] == '423' or $_SESSION["iduser"] == '166' or $_SESSION["iduser"] == '167' or $_SESSION["iduser"] == '168' or $_SESSION["iduser"] == '624' or $_SESSION["iduser"] == '190' or $_SESSION["iduser"] == '197' or $_SESSION["iduser"] == '718' or $_SESSION["iduser"] == '816' or $_SESSION["iduser"] == '835' or $_SESSION["iduser"] == '836' or $_SESSION["iduser"] == '837' or $_SESSION["iduser"] == '177' or $_SESSION["iduser"] == '180' or $_SESSION["iduser"] == '181' or $_SESSION["iduser"] == '487' or $_SESSION["iduser"] == '686') {
					if ($Pro == '' and $Equment == '') {
						...
						$sql = "SELECT*FROM usestock a
						WHERE a.Date >= '$start' and a.Date <= '$end' and a.Provinces like '$Pro'
						ORDER BY a.Date asc ";
					} elseif ($Pro <> '' and $Equment <> '') {
						$sql = "SELECT*FROM usestock a
						WHERE a.Date >= '$start' and a.Date <= '$end' and a.Provinces like '$Pro' and a.Items like '$Equment'
						...
						<table class="table table-hover table-bordered table-sm" border="1">
							...
							<tbody>
								...
								?>
									<tr>
										<td width="10%"><?php echo $row['Provinces'] ?></td>
										<td width="40%"><strong>ຊື່:</strong> <?php echo $row['Items'] ?><br><strong>ພາກສ່ວນ:</strong> <?php echo $row['Section'] ?><br><strong>ເລກຊີລຽວ: </strong><?php echo $row['Series_Number'] ?><br><strong>PR ເລກທີ:</strong> <?php echo $row['OA'] ?><br><strong>Ticket:</strong> <?php echo $row['Ticket'] ?><br><i class="fa-duotone fa-screwdriver-wrench"></i> <strong>ຜູ້ນໍາໃຊ້:</strong> <?php echo $row['Use_Name'] ?></td>
										<td align="center" width="10%"><?php echo $row['Date'] ?></td>
										<td align="center" width="10%"><?php echo $row['Unit'] ?> <?php echo $row['Type'] ?></td>
