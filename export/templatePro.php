...
while(@$row23 = $result23->fetch_assoc())
	...
	?>
      <tr bgcolor="<?php echo $bgcolor?>"  style="font-size: 13px;">
        ...
        <td width="40%"><p>
		<strong><?php echo $row23['Items']?></p><i class="fa-solid fa-network-wired"></i> ອຸປະກອນ: <?php echo $row23['Use_For']?><br><i class="fa-duotone fa-layer-group"></i> ໃຊ້ກັບກຸ່ມ: <?php echo $row23['Groupp']?></strong></td>
        ...
        <td width="20%"><?php echo $row23['picture']?></td>
