...
<body>
    ...
    <table class="table table-bordered  ">
        ...
        <tbody>
            ...
            $selectFields = $isHQ
                ? "stock.Item_code, stock.Items, stock.id, stock.Unit, stock.Type, stock.Vendor, stock.Use_For, stock.Groupp, stock.Stock_TMD, stock.picture, stock.Item_name_Chinese, stock.Size, stock.Model"
                : "stock_province.Item_code, stock_province.Items, stock_province.id, stock_province.Unit, stock_province.Type, stock_province.Vendor, stock_province.Use_For, stock_province.Groupp, stock.Stock_TMD, stock_province.picture, stock.Item_name_Chinese, stock.Size, stock.Model";
            $fromClause = $isHQ
                ? 'stock'
