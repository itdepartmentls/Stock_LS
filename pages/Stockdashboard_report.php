	...
	<div class="d-flex" id="wrapper">
		...
		<div class="border-end" id="sidebar-wrapper">
			...
			<div class="list-group list-group-flush">
                        <a class="list-group-item list-group-item-action p-3 active" href="StockDashboard.php">
                              <i class="fa-solid fa-chart-simple"></i>
                              <strong>Dashboard ສາງ</strong>
                        </a>
				<a class="list-group-item list-group-item-action p-3 <?php echo navActive('Dasborad.php', $currentPage); ?>" href="Dasborad.php">
				...
				<?php if (!in_array($_SESSION["iduser"] ?? '', ['30', '194', '204', '213', '214', '215'])): ?>
					<a class="list-group-item list-group-item-action p-3 <?php echo navActive('UseStock.php', $currentPage); ?>" href="UseStock.php">
						<i class="fa fa-tasks" aria-hidden="true"></i>
						<strong data-translate="use_equipment">ນຳໃຊ້ອຸປະກອນ</strong>
					</a>
				<?php endif; ?>
				<a class="list-group-item list-group-item-action p-3 <?php echo navActive('follow.php', $currentPage); ?>" href="follow.php">
					<i class="fi fi-sr-location-alt"></i>
					<strong data-translate="track_equipment">ຕິດຕາມ ອຸປະກອນ</strong>
				</a>
				<a class="list-group-item list-group-item-action p-3 <?php echo navActive('stock.php', $currentPage); ?>" href="stock.php">
				...
				<?php if (isset($_SESSION['factory']) && strcasecmp(trim($_SESSION['factory']), 'HQ') === 0): ?>
					<a class="list-group-item list-group-item-action p-3 <?php echo navActive('tacking.php', $currentPage); ?>" href="tacking.php">
						<i class="fa-solid fa-truck-fast"></i>
						<strong data-translate="tacking">ຕິດຕາມການສົ່ງເຄື່ອງ</strong>
					</a>
					<a class="list-group-item list-group-item-action p-3 <?php echo navActive('report_tacking.php', $currentPage); ?>" href="report_tacking.php">
						<i class="bi bi-bar-chart-line-fill"></i>
						<strong data-translate="report_tacking">ລາງານການສົ່ງເຄື່ອງ</strong>
					</a>
				<?php else: ?>
					<a class="list-group-item list-group-item-action p-3 <?php echo navActive('inbox_tacking.php', $currentPage); ?>" href="inbox_tacking.php">
				...
				<a class="list-group-item list-group-item-action p-3 <?php echo navActive('Report.php', $currentPage); ?>" href="Report.php">
					<i class="fa fa-bar-chart" aria-hidden="true"></i>
					<strong data-translate="report">Report</strong>
				</a>
				<a class="list-group-item list-group-item-action p-3 <?php echo navActive('index.php', $currentPage); ?>" href="picture/index.php">
